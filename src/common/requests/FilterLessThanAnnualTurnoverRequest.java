...
public class FilterLessThanAnnualTurnoverRequest extends Request implements RequestWithParameters{
    private long annualTurnover;
    public FilterLessThanAnnualTurnoverRequest(String commandName) {
        super(commandName);
    }
